...
set output 'PowerDensity_vs_EtaTPV_0ML.png'
plot 'Scan_0ML.txt' u 9:8 w p title '0 ML', \
'TiN_Alumina_BR_0ML_Pareto.txt' u 8:7 w p title 'Pareto Front'
...
set output 'SpectralEfficiency_vs_EtaTPV_0ML.png'
plot 'Scan_0ML.txt' u 9:7 w p title '0 ML', \
'TiN_Alumina_BR_0ML_Pareto.txt' u 8:6 w p title 'Pareto Front'
